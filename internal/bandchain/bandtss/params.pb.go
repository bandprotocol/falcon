...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n3, err3 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(
		m.MaxTransitionDuration,
		dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.MaxTransitionDuration):],
	)
	if err3 != nil {
		return 0, err3
	}
	...
	i--
	dAtA[i] = 0x22
	n4, err4 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(
		m.MinTransitionDuration,
		dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.MinTransitionDuration):],
	)
	if err4 != nil {
		return 0, err4
	}
	...
	i--
	dAtA[i] = 0x1a
	n5, err5 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(
		m.InactivePenaltyDuration,
		dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.InactivePenaltyDuration):],
	)
	if err5 != nil {
		return 0, err5
	}
